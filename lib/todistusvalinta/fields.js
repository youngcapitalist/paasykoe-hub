...
export const SUBJECT_ROWS = [
  { key: "aidinkieli", label: "Äidinkieli ja kirjallisuus", required: true },
  { key: "matematiikka_pitka", label: "Matematiikka, pitkä oppimäärä" },
  { key: "matematiikka_lyhyt", label: "Matematiikka, lyhyt oppimäärä" },
  { key: "biologia", label: "Biologia" },
  { key: "kemia", label: "Kemia" },
  { key: "fysiikka", label: "Fysiikka" },
  { key: "maantiede", label: "Maantiede" },
  { key: "psykologia", label: "Psykologia" },
  { key: "terveystieto", label: "Terveystieto" },
  { key: "historia", label: "Historia" },
  { key: "yhteiskuntaoppi", label: "Yhteiskuntaoppi" },
  { key: "filosofia", label: "Filosofia" },
  { key: "pitka_kieli", label: "Pitkä vieras kieli" },
  { key: "keskipitka_kieli", label: "Keskipitkä vieras kieli" },
  { key: "lyhyt_englanti", label: "Englanti, lyhyt oppimäärä" },
  { key: "lyhyt_kieli", label: "Muu lyhyt vieras kieli" },
];
